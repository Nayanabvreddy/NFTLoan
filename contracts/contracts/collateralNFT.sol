...
contract collateralNFT {
  ...
  mapping(uint256 => collateralNFT) public collateralNFTs;
  ...
  function createLoan(
    ...
    // Create loan
    collateralNFTs[loanId].tokenAddress = _tokenAddress;
    collateralNFTs[loanId].tokenOwner = msg.sender;
    collateralNFTs[loanId].tokenId = _tokenId;
    collateralNFTs[loanId].interestRate = _interestRate;
    collateralNFTs[loanId].maxLoanAmount = _maxLoanAmount;
    collateralNFTs[loanId].loanCompleteTime = _loanCompleteTime;
   ...
   * @param _loanId collateralNFT id
  ...
  function calculateInterestAccrued(uint256 _loanId, uint256 _future)
    ...
    returns (uint256)
  {
    collateralNFT memory loan = collateralNFTs[_loanId];
  ...
  function underwriteLoan(uint256 _loanId) external payable {
    collateralNFT storage loan = collateralNFTs[_loanId];
